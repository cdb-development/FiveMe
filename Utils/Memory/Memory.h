...
/*	[+] メモリやオーバーレイの初期化モードを設定します
	...
	WINDOW_TITLE : Use the window title.
	WINDOW_CLASS : Use the window class name.
	PROCESS      : Use the executable file name.					*/
...
// A fantastic Memory class that will make coding a little easier from now on.
class Memory
{
private:
